...
export class AESAlgo extends BlockCipher {
   ...
   */
  getUint8Memory0() {
    if (this.cachegetUint8Memory0 === null || this.cachegetUint8Memory0.buffer !== AESAlgo.wasm.memory.buffer) {
      this.cachegetUint8Memory0 = new Uint8Array(AESAlgo.wasm.memory.buffer);
    }
   ...
   */
  getUint32Memory0() {
    if (this.cachegetUint32Memory0 === null || this.cachegetUint32Memory0.buffer !== AESAlgo.wasm.memory.buffer) {
      this.cachegetUint32Memory0 = new Uint32Array(AESAlgo.wasm.memory.buffer);
    }
    return this.cachegetUint32Memory0;
  }
   ...
   * @returns {*}
   */
  passArray32ToWasm0(arg, malloc) {
    const ptr = malloc(arg.length * 4);
    this.getUint32Memory0().set(arg, ptr / 4);
  ...
  /**
   * Modified from glue code generated by wasm-build
   * @type {{prototype: TextEncoder, new(): TextEncoder}}
   */
   ...
   * @type {TextEncoder}
   */
  cachedTextEncoder = new this.lTextEncoder('utf-8');

  /**
   * Modified from glue code generated by wasm-build
   * @type {(function(*=, *=): *)|(function(*=, *): {read: *, written: number})}
   */
  encodeString = (typeof this.cachedTextEncoder.encodeInto === 'function'
    ? function (arg, view) {
  ...
  _process(doFlush) {
    ...
    if (nWordsReady) {
      ...
      if (this._xformMode == this._ENC_XFORM_MODE) {
        ...
        this._decrypt(this.cfg.mode.name, this._nRounds, nWordsReady, blockSize, ivWords, dataArray, this._invKeySchedule, INV_SUB_MIX_0, INV_SUB_MIX_1, INV_SUB_MIX_2, INV_SUB_MIX_3, INV_SBOX);
      }
