    ...
    namespace CryptoJSWasm {
        ...
        export namespace lib {
            ...
            interface CipherParams {
                 ...
                 *     var string = cipherParams.toString(CryptoJSWasm.format.OpenSSL);
                 */
            ...
            const CipherParams: {
                 ...
                 * @example
                 *
                 *     var cipherParams = CryptoJSWasm.lib.CipherParams.create({
                 *         ciphertext: ciphertextWordArray,
                 *         key: keyWordArray,
                 *         iv: ivWordArray,
                 *         salt: saltWordArray,
                 *         algorithm: CryptoJSWasm.algo.AES,
                 *         mode: CryptoJSWasm.mode.CBC,
                 *         padding: CryptoJSWasm.pad.PKCS7,
                 *         blockSize: 4,
                 *         formatter: CryptoJSWasm.format.OpenSSL
                 *     });
                 */
            ...
            const SerializableCipher: {
                 ...
                 * @example
                 *
                 *     var ciphertextParams = CryptoJSWasm.lib.SerializableCipher.encrypt(CryptoJSWasm.algo.AES, message, key);
                 *     var ciphertextParams = CryptoJSWasm.lib.SerializableCipher.encrypt(CryptoJSWasm.algo.AES, message, key, { iv: iv });
                 *     var ciphertextParams = CryptoJSWasm.lib.SerializableCipher.encrypt(CryptoJSWasm.algo.AES, message, key, { iv: iv, format: CryptoJSWasm.format.OpenSSL });
                 */
                encrypt(
                    cipher: WasmCipherStatic,
                 ...
                 * @example
                 *
                 *     var plaintext = CryptoJSWasm.lib.SerializableCipher.decrypt(CryptoJSWasm.algo.AES, formattedCiphertext, key, { iv: iv, format: CryptoJSWasm.format.OpenSSL });
                 *     var plaintext = CryptoJSWasm.lib.SerializableCipher.decrypt(CryptoJSWasm.algo.AES, ciphertextParams, key, { iv: iv, format: CryptoJSWasm.format.OpenSSL });
                 */
                decrypt(
                    cipher: WasmCipherStatic,
                 ...
                 * @example
                 *
                 *     var ciphertextParams = CryptoJSWasm.lib.SerializableCipher._parse(ciphertextStringOrParams, format);
                 */
            ...
            const PasswordBasedCipher: {
                 ...
                 * @example
                 *
                 *     var ciphertextParams = CryptoJSWasm.lib.PasswordBasedCipher.encrypt(CryptoJSWasm.algo.AES, message, 'password');
                 *     var ciphertextParams = CryptoJSWasm.lib.PasswordBasedCipher.encrypt(CryptoJSWasm.algo.AES, message, 'password', { format: CryptoJSWasm.format.OpenSSL });
                 */
                encrypt(
                    cipher: WasmCipherStatic,
                    message: WordArray | string,
                 ...
                 * @example
                 *
                 *     var plaintext = CryptoJSWasm.lib.PasswordBasedCipher.decrypt(CryptoJSWasm.algo.AES, formattedCiphertext, 'password', { format: CryptoJSWasm.format.OpenSSL });
                 *     var plaintext = CryptoJSWasm.lib.PasswordBasedCipher.decrypt(CryptoJSWasm.algo.AES, ciphertextParams, 'password', { format: CryptoJSWasm.format.OpenSSL });
                 */
                decrypt(
                    cipher: WasmCipherStatic,
        ...
        export namespace kdf {
            ...
            const OpenSSL: {
                 ...
                 * @example
                 *
                 *     var derivedParams = CryptoJSWasm.kdf.OpenSSL.execute('Password', 256/32, 128/32);
                 *     var derivedParams = CryptoJSWasm.kdf.OpenSSL.execute('Password', 256/32, 128/32, 'saltsalt');
                 */
        ...
        export namespace mode {
             ...
             * derived from CryptoJSWasm.mode.CTR
        ...
        export namespace algo {
            ...
            abstract class PBKDF2 {
                 ...
                 * @example
                 *
                 *     var kdf = CryptoJSWasm.algo.PBKDF2.create();
                 *     var kdf = CryptoJSWasm.algo.PBKDF2.create({ keySize: 8 });
                 *     var kdf = CryptoJSWasm.algo.PBKDF2.create({ keySize: 8, iterations: 1000 });
                 */
            ...
            abstract class EvpKDF {
                 ...
                 * @example
                 *
                 *     var kdf = CryptoJSWasm.algo.EvpKDF.create();
             ...
             */
            const AES: WasmCipherStatic;

            /**
             * Blowfish block cipher algorithm.
             */
            const Blowfish: WasmCipherStatic;

            /**
             * DES block cipher algorithm.
             */
            const DES: WasmCipherStatic;

            /**
             * Triple-DES block cipher algorithm.
             */
            const TripleDES: WasmCipherStatic;

            /**
             * RC4 stream cipher algorithm.
             */
            const RC4: WasmCipherStatic;

            /**
             * Modified RC4 stream cipher algorithm.
             */
            const RC4Drop: WasmCipherStatic;

            /**
             * Rabbit stream cipher algorithm
             */
            const Rabbit: WasmCipherStatic;
             ...
             */
            const RabbitLegacy: WasmCipherStatic;
        ...
        export namespace x64 {
            ...
            const Word: {
                 ...
                 * @example
                 *
                 *     var x64Word = CryptoJSWasm.x64.Word.create(0x00010203, 0x04050607);
                 */
             ...
             * Initializes a newly created word array.
             *
             * @param words (Optional) An array of CryptoJSWasm.x64.Word objects.
             * @param sigBytes (Optional) The number of significant bytes in the words.
             *
             * @example
             *
             *     var wordArray = CryptoJSWasm.x64.WordArray.create();
             *
             *     var wordArray = CryptoJSWasm.x64.WordArray.create([
             *         CryptoJSWasm.x64.Word.create(0x00010203, 0x04050607),
             *         CryptoJSWasm.x64.Word.create(0x18191a1b, 0x1c1d1e1f)
             *     ]);
             *
             *     var wordArray = CryptoJSWasm.x64.WordArray.create([
             *         CryptoJSWasm.x64.Word.create(0x00010203, 0x04050607),
         ...
         * @example
         *
         *     var key = CryptoJSWasm.PBKDF2(password, salt);
         *     var key = CryptoJSWasm.PBKDF2(password, salt, { keySize: 8 });
         *     var key = CryptoJSWasm.PBKDF2(password, salt, { keySize: 8, iterations: 1000 });
         */
         ...
         * @example
         *
         *     var ciphertext = CryptoJSWasm.AES.encrypt(message, key, cfg);
         *     var plaintext  = CryptoJSWasm.AES.decrypt(ciphertext, key, cfg);
         */
        export const AES: WasmCipherHelper;
         ...
         * @example
         *
         *     var ciphertext = CryptoJSWasm.Blowfish.encrypt(message, key, cfg);
         *     var plaintext  = CryptoJSWasm.Blowfish.decrypt(ciphertext, key, cfg);
         */
        export const Blowfish: WasmCipherHelper;
         ...
         * @example
         *
         *     var ciphertext = CryptoJSWasm.DES.encrypt(message, key, cfg);
         *     var plaintext  = CryptoJSWasm.DES.decrypt(ciphertext, key, cfg);
         */
        export const DES: WasmCipherHelper;
         ...
         * @example
         *
         *     var ciphertext = CryptoJSWasm.TripleDES.encrypt(message, key, cfg);
         *     var plaintext  = CryptoJSWasm.TripleDES.decrypt(ciphertext, key, cfg);
         */
        export const TripleDES: WasmCipherHelper;
         ...
         * @example
         *
         *     var ciphertext = CryptoJSWasm.RC4.encrypt(message, key, cfg);
         *     var plaintext  = CryptoJSWasm.RC4.decrypt(ciphertext, key, cfg);
         */
        export const RC4: WasmCipherHelper;
         ...
         * @example
         *
         *     var ciphertext = CryptoJSWasm.RC4Drop.encrypt(message, key, cfg);
         *     var plaintext  = CryptoJSWasm.RC4Drop.decrypt(ciphertext, key, cfg);
         */
        export const RC4Drop: WasmCipherHelper;
         ...
         * @example
         *
         *     var ciphertext = CryptoJSWasm.Rabbit.encrypt(message, key, cfg);
         *     var plaintext  = CryptoJSWasm.Rabbit.decrypt(ciphertext, key, cfg);
         */
        export const Rabbit: WasmCipherHelper;
         ...
         * @example
         *
         *     var ciphertext = CryptoJSWasm.RabbitLegacy.encrypt(message, key, cfg);
         *     var plaintext  = CryptoJSWasm.RabbitLegacy.decrypt(ciphertext, key, cfg);
         */
         ...
         */
        export const RSA: RSAAlgoShortcut;
         ...
         * @example
         *
         *     var key = CryptoJSWasm.EvpKDF(password, salt);
         *     var key = CryptoJSWasm.EvpKDF(password, salt, { keySize: 8 });
         *     var key = CryptoJSWasm.EvpKDF(password, salt, { keySize: 8, iterations: 1000 });
         */
